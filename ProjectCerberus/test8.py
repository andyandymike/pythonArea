...
for table in tables:
    ...
    for dfline in df:
        ...
        if table.upper().find('_VARHCAR') != -1:
            dfline = dfline.replace(oldstring, table + '.VARHCARCOL = ' + table.replace('1', '2') + '.VARHCARCOL')
        if table.upper().find('_NVARHCAR') != -1:
            dfline = dfline.replace(oldstring, table + '.NVARHCARCOL = ' + table.replace('1', '2') + '.NVARHCARCOL')
