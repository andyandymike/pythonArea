...
FileStatus = os.path.isfile('C:\\Users\\i067382\\Desktop\\New folder\\ct46dfs.atl')
if FileStatus is True:
    os.remove('C:\\Users\\i067382\\Desktop\\New folder\\ct46dfs.atl')

df = ReadFromFile('C:\\Users\\i067382\\Desktop\\New folder\\ct46df.atl')
...
for table in tables:
    ...
    outname = 'testcase046_1_wf' + str(i) + '.out'
    dfname = 'testcase046_1_df' + str(i)
    wfname = 'testcase046_1_wf' + str(i)
    ...
    j = j + 1
    for dfline in df:
        dfline = dfline.replace('testcase046_1_wf1',wfname)
        ...
        dfline = dfline.replace('testcase046_1_df1',dfname)
        ...
        WriteToFile('C:\\Users\\i067382\\Desktop\\New folder\\ct46dfs.atl',dfline)
