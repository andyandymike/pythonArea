...
FileStatus = os.path.isfile('C:\\Users\\i067382\\Desktop\\New folder\\ct53dfs.atl')
if FileStatus is True:
    os.remove('C:\\Users\\i067382\\Desktop\\New folder\\ct53dfs.atl')

df = ReadFromFile('C:\\Users\\i067382\\Desktop\\New folder\\ct53df.atl')
...
for table in tables:
    ...
    guid1 = 'facd480c-c9fb-4750-9fcc-1a2c58cb8d12'
    guid1new = 'facd480c-c9fb-4750-9fcc-1a2c58cb8' + str(j)
    guid2 = '800092f6-00f8-42dc-9f16-122907826100'
    guid2new = '800092f6-00f8-42dc-9f16-122907826' + str(j)
    guid3 = '1e0c3e5d-5f71-45fb-be08-f1488f10c100'
    guid3new = '1e0c3e5d-5f71-45fb-be08-f1488f10c' + str(j)
    guid4 = '88b419fd-dda1-4638-a708-959512d6f100'
    guid4new = '88b419fd-dda1-4638-a708-959512d6f' + str(j)

    guid5 = 'ad8f3039-4a43-496e-a373-f124f60e9100'
    guid5new = 'ad8f3039-4a43-496e-a373-f124f60e9' + str(j)
    ...
    for dfline in df:
        ...
        WriteToFile('C:\\Users\\i067382\\Desktop\\New folder\\ct53dfs.atl',dfline)
