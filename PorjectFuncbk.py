...
def AskForInput(AskPhrase, NeedConfirm = True, IsPassword = False):
    ...
    if NeedConfirm is True:
         while IsCorrect.upper() != 'Y' and IsCorrect.upper() != 'YES':
            ...
            while ConfrimChoice is False:
                IsCorrect = input('Does you input ' + InputValue + ' correct? [Y/N]: ')
...
#Not used old function. According to new design, will use register key to get DS version
...
def GetBOEVersion(BOEPackageLoc, DoNotPrint=0):
    ...
    if FileStatus is False:
        if DoNotPrint == 0:
            print('Cerberus cannot detect your BOE package version! Check your BOE package!')
        return False
...
def GetBOEPackageType(BOEPackageLoc, DoNotPrint=0):
    ...
    if FileStatus is False:
        if DoNotPrint == 0:
            print('Cerberus cannot detect your BOE package type! Check your BOE package!')
        return False
    PackageBOEVersionList = open(BOEPackageLoc + '\\ProductId.txt')
    try:
...
def GetDSVersion(DSPackageLoc, DoNotPrint=0):
    ...
    if FileStatus is False:
        if DoNotPrint == 0:
            print('Cerberus cannot detect your DS package version! Check your DS package!')
        return False
...
def PrintMachineInstallationStatus(ProjectPath):
    print('Your Machine Status now are:')
    ...
    if InstalledBOEInfoList is False:
        ...
        if InstalledBOEInfoList == []:
            print('BOE not installed on your machine')
        else:
    ...
    if InstalledDSVersion is False:
        print('Error: Cerberus get error when try to get installed DS version')
    else:
        if InstalledDSVersion == -1:
            print('DS not installed on your machine')
        if InstalledDSVersion != -1:
