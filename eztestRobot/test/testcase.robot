...
|  | Export Env | JOBNAME | 001__HANA_BKL_DDL_CreateTables 
...
|  | Export Env | JOBNAME | 100_HANA_BKL_Gen_Inp_DataSet 
...
|  | Shell Command | rm \${DS_WORK}/HANA_BKL_Job.out 
|  | Export Env | JOBNAME | 101_HANA_BKL_AutoCorrect_Insert 
|  | EIM Launcher | \${JOBNAME} | -KspS1 -T2062 -l\${UDS_WORK}/\${JOBNAME}.log -z\${UDS_WORK}/\${JOBNAME}.txt
...
|  | Shell Command | rm \${DS_WORK}/HANA_BKL_Job.out 
|  | Export Env | JOBNAME | 102_HANA_BKL_AutoCorrect_Update 
|  | EIM Launcher | \${JOBNAME} | -KspS1 -T2062 -l\${UDS_WORK}/\${JOBNAME}.log -z\${UDS_WORK}/\${JOBNAME}.txt
...
|  | Shell Command | rm \${DS_WORK}/HANA_BKL_Job.out 
|  | Export Env | JOBNAME | 103_HANA_BKL_AutoCorrect_DeleteInsert 
|  | EIM Launcher | \${JOBNAME} | -KspS1 -T2062 -l\${UDS_WORK}/\${JOBNAME}.log -z\${UDS_WORK}/\${JOBNAME}.txt
...
|  | Shell Command | rm \${DS_WORK}/HANA_BKL_Job.out 
|  | Export Env | JOBNAME | 104_HANA_BKL_DeleteInsert 
|  | EIM Launcher | \${JOBNAME} | -KspS1 -T2062 -l\${UDS_WORK}/\${JOBNAME}.log -z\${UDS_WORK}/\${JOBNAME}.txt
...
|  | Shell Command | rm \${DS_WORK}/HANA_BKL_Job.out 
|  | Export Env | JOBNAME | 105_HANA_BKL_Update 
|  | EIM Launcher | \${JOBNAME} | -KspS1 -T2062 -l\${UDS_WORK}/\${JOBNAME}.log -z\${UDS_WORK}/\${JOBNAME}.txt
...
|  | Shell Command | rm \${DS_WORK}/HANA_BKL_Job.out 
|  | Export Env | JOBNAME | 106_HANA_BKL_Delete 
|  | EIM Launcher | \${JOBNAME} | -KspS1 -T2062 -l\${UDS_WORK}/\${JOBNAME}.log -z\${UDS_WORK}/\${JOBNAME}.txt
...
|  | Export Env | JOBNAME | 002__HANA_BKL_DDL_2_RowBase 
